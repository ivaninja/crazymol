...
<?php
	  ...
	  $rows = 1;
   ?>
<div class="occountdown_module module-nav2">
<?php if ($title): ?>
<div class="countdown-title group-title2"><h2><?php echo $title; ?></h2></div>
<?php endif; ?>
<?php if($products): ?>
...
<script type="text/javascript">
	...
	$('.countdown-product-inner').owlCarousel({
		...
		afterAction: function(){
			...
			$(".countdown-product-inner .owl-wrapper .owl-item").removeClass('last');
			$(".countdown-product-inner .owl-wrapper .owl-item").removeClass('before-active');
			$(".countdown-product-inner .owl-wrapper .owl-item.active:first").addClass('first');
			$(".countdown-product-inner .owl-wrapper .owl-item.active:last").addClass('last');
			$('.countdown-product-inner .owl-wrapper .owl-item.active:first').prev().addClass('before-active');
		},
