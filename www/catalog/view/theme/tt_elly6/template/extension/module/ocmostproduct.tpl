<div class="mostviewed-products-slider special-button-owl module-sidebar">
   <?php if($title): ?>  
   ...
   <div class="mostviewed_products_slider">
	   	<?php if($products): ?>
...
$(document).ready(function() { 
  $(".mostviewed_products_slider").owlCarousel({
		...
		afterAction: function(){
			$(".mostviewed_products_slider .owl-wrapper .owl-item").removeClass('first');
			$(".mostviewed_products_slider .owl-wrapper .owl-item").removeClass('last');
			$(".mostviewed_products_slider .owl-wrapper .owl-item").removeClass('before-active');
			$(".mostviewed_products_slider .owl-wrapper .owl-item.active:first").addClass('first');
			$(".mostviewed_products_slider .owl-wrapper .owl-item.active:last").addClass('last');
			$('.mostviewed_products_slider .owl-wrapper .owl-item.active:first').prev().addClass('before-active');
		}
