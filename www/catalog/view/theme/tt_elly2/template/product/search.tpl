					...
					<div class="product-layout product-list ">
					  ...
					  <script type="text/javascript">
							$(document).ready(function() {
								$(".product-list .item<?php echo $count; ?> .button.btn-cart").appendTo('.product-list .item<?php echo $count; ?> .des-container');
								$('#grid-view').click(function() {
									$(".item<?php echo $count; ?> .button.btn-cart").appendTo('.item<?php echo $count; ?> .actions');
									$(".item<?php echo $count; ?> .add-to-links").appendTo('.item<?php echo $count; ?> .actions');
								});
								$('#list-view').click(function() {
									$(".item<?php echo $count; ?> .button.btn-cart").appendTo('.item<?php echo $count; ?> .des-container');
								});
							});
						</script>
					</div>
