    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-countdown" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-countdown" class="form-horizontal">
				  ...
				  <div class="form-group">
					<label class="col-sm-2 control-label" for="input-showwishlist"><?php echo  $entry_showwishlist ?></label>
					<div class="col-sm-10">
					 <select id="input-showwishlist" name="showwishlist" class="form-control">
							<option value="0" <?php if($showwishlist==0) { ?> selected="selected" <?php } ?> >No</option>
							<option value="1" <?php if($showwishlist==1) { ?> selected="selected" <?php } ?> >Yes</option>
					</select>
					</div>
				  </div>
				  
				  <div class="form-group">
					<label class="col-sm-2 control-label" for="input-showcompare"><?php echo  $entry_showcompare ?></label>
					<div class="col-sm-10">
					<select id="input-showcompare" name="showcompare" class="form-control">
							<option value="0" <?php if($showcompare==0) { ?> selected="selected" <?php } ?> >No</option>
							<option value="1" <?php if($showcompare==1) { ?> selected="selected" <?php } ?> >Yes</option>
					</select>
					</div>
				  </div>
                    <div class="form-group">
					...
					<div class="form-group">
                        <label class="col-sm-2 control-label" for="input-usethumbslide"><?php echo $entry_usethumbslide ?></label>
                        <div class="col-sm-10">
                            <select id="input-usethumbslide" name="usethumbslide" class="form-control">
                                <option value="0" <?php if($usethumbslide == 0) { ?> selected="selected" <?php } ?> >No</option>
                                <option value="1" <?php if($usethumbslide == 1) { ?> selected="selected" <?php } ?> >Yes</option>
                            </select>
                        </div>
                    </div>
                </form>
